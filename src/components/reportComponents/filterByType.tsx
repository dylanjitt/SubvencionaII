...
import { useFilterByType } from "../../hooks/useReportFilters/useFilterByType";
import RestartAltIcon from "@mui/icons-material/RestartAlt";

export const FilterByType = ({ tickets, title }: TicketDataProps) => {

  const { chartRef, filteredData, gasType, singleDate, rangeEnd, rangeStart, setSingleDate, setRangeEnd, setRangeStart, stationFilter, setStationFilter, gasStationNames, restoreAll, getCurrentFilters, filteredticketsExport } = useFilterByType(tickets)
